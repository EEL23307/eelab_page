...
export const koreanConferences: Publication[] = [
{
  ...
  journal: '2026 한국에너지기후변화학회 춘계학술대회(우수발표상(구두발표)), 2026.5.20-22, 대전'
},
{
  id: 'kc-2026-4',
  year: 2026,
...
},
{
  id: 'kc-2026-2',
  year: 2026,
  title: '석탄화력 보일러 NOx 배출 저감을 위한 딥러닝 기반 성능 예측 및 운전 최적화 모델 개발',
  authors: '구윤하, 조현빈, 장아롱, 류창국',
  journal: '2026 한국연소학회 춘계학술대회, 2026.5.13-15, 부산'
},
{
  ...
  authors: '이정호, 남준영, 류창국, 신민수, 이승문',
  journal: '2026 대한금속재료학회 춘계학술대회, 2026.4.28-30, 제주'
},
...
},
{
  ...
  journal: '2025 한국환경에너지공학회 추계학술대회(우수논문상(구두발표)), 2025.12.10-12, 제주'
},
{
  id: 'kc-2025-3',
  year: 2025,
